...
class Grader:
    ...
    CASES: Dict[str, TestCase] = {
        "1": TestCase(CaseType.OPEN, 5.0, "01_table"),
        "2": TestCase(CaseType.OPEN, 4.5, "02_redecl"),
        "3": TestCase(CaseType.OPEN, 3.0, "03_variable"),
        "4": TestCase(CaseType.OPEN, 3.0, "04_VariableReference"),
        "5": TestCase(CaseType.OPEN, 3.0, "05_BinaryOperator"),
        "6": TestCase(CaseType.OPEN, 3.0, "06_UnaryOperator"),
        "7": TestCase(CaseType.OPEN, 3.0, "07_FunctionInvocation"),
        "8": TestCase(CaseType.OPEN, 3.0, "08_PrintStatement"),
        "9": TestCase(CaseType.OPEN, 3.0, "09_ReadStatement"),
        "10": TestCase(CaseType.OPEN, 3.0, "10_assignment"),
        "11": TestCase(CaseType.OPEN, 3.0, "11_condition"),
        "12": TestCase(CaseType.OPEN, 3.0, "12_ForLoop"),
        "13": TestCase(CaseType.OPEN, 3.0, "13_ret"),
        "14": TestCase(CaseType.OPEN, 2.5, "14_AdvanceSymbol"),
        "15": TestCase(CaseType.OPEN, 2.5, "15_AdvanceSema"),
        "h1": TestCase(CaseType.HIDDEN, 5.0, "h01_table"),
        "h2": TestCase(CaseType.HIDDEN, 4.5, "h02_redecl"),
        "h3": TestCase(CaseType.HIDDEN, 3.0, "h03_variable"),
        "h4": TestCase(CaseType.HIDDEN, 3.0, "h04_VariableReference"),
        "h5": TestCase(CaseType.HIDDEN, 3.0, "h05_BinaryOperator"),
        "h6": TestCase(CaseType.HIDDEN, 3.0, "h06_UnaryOperator"),
        "h7": TestCase(CaseType.HIDDEN, 3.0, "h07_FunctionInvocation"),
        "h8": TestCase(CaseType.HIDDEN, 3.0, "h08_PrintStatement"),
        "h9": TestCase(CaseType.HIDDEN, 3.0, "h09_ReadStatement"),
        "h10": TestCase(CaseType.HIDDEN, 3.0, "h10_assignment"),
        "h11": TestCase(CaseType.HIDDEN, 3.0, "h11_condition"),
        "h12": TestCase(CaseType.HIDDEN, 3.0, "h12_ForLoop"),
        "h13": TestCase(CaseType.HIDDEN, 3.0, "h13_ret"),
        "h14": TestCase(CaseType.HIDDEN, 2.5, "h14_AdvanceSymbol"),
        "h15": TestCase(CaseType.HIDDEN, 2.5, "h15_AdvanceSema"),
