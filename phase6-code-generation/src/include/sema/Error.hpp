...
class InvalidBinaryOperandError : public Error {
   public:
    ...
    InvalidBinaryOperandError(Location, OperatorType, const Type p_lhs, const Type p_rhs);
...
class InvalidUnaryOperandError : public Error {
   public:
    ...
    InvalidUnaryOperandError(Location, OperatorType, const Type p_operand);

   private:
    OperatorType m_op;
    const Type m_operand;
};
...
class IncompatibleArgumentTypeError : public Error {
   public:
    ...
    IncompatibleArgumentTypeError(Location, const Type p_expected, const Type p_actual);
...
class IncompatibleAssignmentError : public Error {
   public:
    ...
    IncompatibleAssignmentError(Location, const Type p_lval, const Type p_rval);
...
class IncompatibleReturnTypeError : public Error {
   public:
    ...
    IncompatibleReturnTypeError(Location, const Type p_expected, const Type p_actual);
